...
/*
 * @category    Alpenite
 * @package     Alpenite_AlpenCms
 * @author      Alpenite Magento Developer Team <dtognana@alpenite.com>
 */

class Alpenite_Blog_Block_Adminhtml_Store_Switcher extends Mage_Adminhtml_Block_Template {
    /**
